      ...
      <div className="grid md:grid-cols-3 gap-8 w-full max-w-5xl">
        ...
        <div className="card w-full bg-base-100 shadow-xl transition-transform transform hover:scale-105">
          ...
          <div className="card-body items-center text-center">
            ...
            <p className="text-sm text-gray-500">Explore as cidades e seus pontos de interesse no mapa.</p>
            <div className="card-actions mt-4">
              <button className="btn btn-primary" onClick={() => alert("Navegar para Consultar Cidades")}>
                Acessar
              </button>
            </div>
          </div>
        ...
        <div className="card w-full bg-base-100 shadow-xl transition-transform transform hover:scale-105">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions mt-4">
              <button className="btn btn-secondary" onClick={() => alert("Navegar para Cadastrar Cidade")}>
                Acessar
              </button>
            </div>
          </div>
        ...
        <div className="card w-full bg-base-100 shadow-xl transition-transform transform hover:scale-105">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions mt-4">
              <button className="btn btn-accent" onClick={() => alert("Navegar para Cadastrar Local")}>
                Acessar
              </button>
            </div>
          </div>
